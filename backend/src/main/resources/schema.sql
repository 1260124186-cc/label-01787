...
CREATE TABLE IF NOT EXISTS book (
    ...
    book_format VARCHAR(10) NOT NULL DEFAULT 'pdf' COMMENT '文件格式(pdf/epub/mobi)',
    page_count INT DEFAULT 0 COMMENT '总页数(PDF)',
    chapter_count INT DEFAULT 0 COMMENT '总章节数(EPUB)',
    category_id BIGINT DEFAULT NULL COMMENT '分类ID',
    last_page INT DEFAULT 0 COMMENT '上次阅读页码(PDF)',
    last_chapter INT DEFAULT 0 COMMENT '上次阅读章节(EPUB)',
